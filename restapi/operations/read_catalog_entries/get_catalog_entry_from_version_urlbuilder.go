...
func (o *GetCatalogEntryFromVersionURL) WithBasePath(bp string) *GetCatalogEntryFromVersionURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetCatalogEntryFromVersionURL) Build() (*url.URL, error) {
	...
	var _path = "/catalogEntries/{providerId}/versions/{version}"

	providerID := o.ProviderID
	if providerID != "" {
		_path = strings.Replace(_path, "{providerId}", providerID, -1)
	} else {
		return nil, errors.New("providerId is required on GetCatalogEntryFromVersionURL")
	}
	...
	if version != "" {
		...
		return nil, errors.New("version is required on GetCatalogEntryFromVersionURL")
	}
...
func (o *GetCatalogEntryFromVersionURL) String() string {
...
func (o *GetCatalogEntryFromVersionURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetCatalogEntryFromVersionURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetCatalogEntryFromVersionURL")
	}
