...
// GetCatalogEntryPackageParams contains all the bound params for the get catalog entry package operation
...
func (o *GetCatalogEntryPackageParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetCatalogEntryPackageParams) bindProviderID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
